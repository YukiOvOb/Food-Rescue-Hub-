...
/**
 * Handles photo storage. Uses Cloudflare R2 (S3-compatible) when enabled; falls back to local disk otherwise.
 */
@Service
public class PhotoStorageService {
    ...
    private String uploadToR2(InputStream input, long contentLength, String key, String contentType) throws IOException {
        ...
        try (S3Client s3 = S3Client.builder()
            ...
            s3.putObject(req, software.amazon.awssdk.core.sync.RequestBody.fromInputStream(input, contentLength));
        }
