...
public class ConsumerOrderService {
  ...
  @Autowired private ConsumerOrderRepository consumerOrderRepository;
  ...
  public List<Order> getOrdersByConsumerIdAndStatus(Long consumerId, String status) {
    return consumerOrderRepository.findByConsumer_ConsumerIdAndStatusOrderByCreatedAtDesc(
        consumerId, status);
  }
  ...
  public Order updateOrder(Long orderId, Order updatedOrder) {
    return consumerOrderRepository
        .findById(orderId)
        .map(
            order -> {
