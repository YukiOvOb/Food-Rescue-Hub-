...
public class OrderService {
    ...
    private OrderSummaryDTO toSummaryDTO(Order o) {
        ...
        // Build nested store info
        OrderSummaryDTO.StoreInfo storeInfo = null;
        if (o.getStore() != null) {
            storeInfo = OrderSummaryDTO.StoreInfo.builder()
                .storeId(o.getStore().getStoreId())
                .storeName(o.getStore().getStoreName())
                .build();
        }

        // Build nested consumer info
        OrderSummaryDTO.ConsumerInfo consumerInfo = null;
        if (o.getConsumer() != null) {
            consumerInfo = OrderSummaryDTO.ConsumerInfo.builder()
                .consumerId(o.getConsumer().getConsumerId())
                .displayName(o.getConsumer().getDisplayName())
                .username(o.getConsumer().getEmail()) // Use email as username fallback
                .build();
        }
