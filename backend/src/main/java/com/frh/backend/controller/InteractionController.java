...
/** Controller for recording user interactions Tracks VIEW, CLICK, SEARCH, and ADD_TO_CART events */
@RestController
...
public class InteractionController {
   ...
   *
   * <p>POST /api/interactions/record Body: { "consumerId": 1, "listingId": 5, "interactionType":
   * "CLICK", "sessionId": "abc123", "deviceType": "Android" }
   */
  @PostMapping("/record")
   ...
   *
   * <p>POST /api/interactions/batch Body: [ {"consumerId": 1, "listingId": 5, "interactionType":
   * "VIEW"}, {"consumerId": 1, "listingId": 6, "interactionType": "VIEW"} ]
   */
  @PostMapping("/batch")
