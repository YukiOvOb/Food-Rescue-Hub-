...
/** 推荐系统API控制器 为Android应用提供个性化商家推荐 */
@RestController
...
public class RecommendationController {
   ...
   * 获取首页推荐商家
   *
   * <p>GET /api/recommendations/homepage?consumerId=1&topK=5&lat=1.3521&lng=103.8198
   *
   ...
   *
   * <p>GET /api/recommendations/search?consumerId=1&query=bread&topK=10&lat=1.3521&lng=103.8198
   *
   ...
   * 健康检查
   *
   * <p>GET /api/recommendations/health
   */
  @GetMapping("/health")
