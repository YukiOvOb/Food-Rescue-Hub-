...
public class AnalyticsController {
    ...
    /**
     * CO2 savings summary for a supplier (default last 30 days)
     * GET /api/analytics/supplier/{supplierId}/co2?days=30
     */
    ...
    /**
     * CO2 savings PDF report for a supplier (default last 30 days)
     * GET /api/analytics/supplier/{supplierId}/co2/report?days=30
     */
    ...
    public ResponseEntity<?> getCo2ReportPdf(
        ...
        try {
            ...
            String filename = "co2-report-supplier-" + supplierId + "-last-" + Math.max(1, days) + "-days.pdf";
