...
public class OrderController {
  ...
  public ResponseEntity<?> createOrder(
    ...
    try {
      ...
      Order order = orderService.createOrderFromCart(consumerId, pickupSlotStart, pickupSlotEnd);
      log.info("Order created successfully with ID: {}", order.getOrderId());
      String pickupToken =
          order.getPickupToken() != null ? order.getPickupToken().getQrTokenHash() : null;
  ...
  /** Get orders by store ID GET /api/orders/store/{storeId} */
  ...
  /** Get orders by store and status GET /api/orders/store/{storeId}/status/{status} */
  ...
  public ResponseEntity<?> updateOrder(
      @PathVariable Long orderId, @RequestBody Order orderDetails) {
  ...
  public ResponseEntity<?> cancelOrder(
      @PathVariable Long orderId, @RequestParam(required = false) String cancelReason) {
