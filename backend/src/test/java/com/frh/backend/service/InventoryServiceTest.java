...
class InventoryServiceTest {
  ...
  void checkStock_missingInventory_throws() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> inventoryService.checkStock(1L, 2));
  ...
  void decrementStock_insufficient_throws() {
    ...
    InsufficientStockException ex =
        assertThrows(
            InsufficientStockException.class, () -> inventoryService.decrementStock(2L, 4));
  ...
  void adjustInventory_belowZero_throws() {
    ...
    IllegalArgumentException ex =
        assertThrows(
            IllegalArgumentException.class, () -> inventoryService.adjustInventory(4L, -3));
  ...
  void getInventory_missing_throws() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> inventoryService.getInventory(5L));
