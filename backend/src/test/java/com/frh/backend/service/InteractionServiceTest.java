...
class InteractionServiceTest {
    ...
    void recordInteraction_view_createsStatsAndDefaultsDeviceType() {
        ...
        when(userInteractionRepository.save(any(UserInteraction.class))).thenAnswer(invocation -> invocation.getArgument(0));
        ...
        when(listingStatsRepository.save(any(ListingStats.class))).thenAnswer(invocation -> invocation.getArgument(0));
        when(consumerStatsRepository.save(any(ConsumerStats.class))).thenAnswer(invocation -> invocation.getArgument(0));
        ...
        ArgumentCaptor<ConsumerStats> consumerStatsCaptor = ArgumentCaptor.forClass(ConsumerStats.class);
    ...
    void recordInteraction_addToCart_updatesOnlyAddToCartCounter() {
        ...
        interactionService.recordInteraction(request(3L, 30L, UserInteraction.InteractionType.ADD_TO_CART, "Android"));
    ...
    void recordInteraction_missingConsumer_throws() {
        ...
        RuntimeException ex = assertThrows(
            ...
            () -> interactionService.recordInteraction(request(99L, 1L, UserInteraction.InteractionType.VIEW, "Android"))
        );
    ...
    void recordInteraction_missingListing_throws() {
        ...
        RuntimeException ex = assertThrows(
            RuntimeException.class,
            () -> interactionService.recordInteraction(request(1L, 404L, UserInteraction.InteractionType.VIEW, "Android"))
        );
    ...
    void recordInteractionsBatch_continuesAfterFailures() {
        UserInteractionRequest invalid = request(1L, 1L, UserInteraction.InteractionType.VIEW, "Android");
        UserInteractionRequest valid = request(2L, 2L, UserInteraction.InteractionType.CLICK, "Android");
    ...
    private static UserInteractionRequest request(Long consumerId, Long listingId,
