...
class Co2AnalyticsServiceTest {
  ...
  void getCo2Summary_normalizesDaysAndSumsOnlyNonNullValues() {
    Co2CategoryBreakdownDto meats =
        new Co2CategoryBreakdownDto(1L, "Meats", new BigDecimal("1.500"), null);
  ...
  void generateCo2ReportPdf_handlesNullValuesAndProducesBytes() {
    ...
    summary.setCategories(List.of(new Co2CategoryBreakdownDto(1L, "Meats", null, null)));
