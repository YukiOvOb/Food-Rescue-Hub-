...
class ListingReviewServiceTest {
    ...
    void createReview_success() {
        ...
        when(listingReviewRepository.existsByOrder_OrderIdAndListing_ListingIdAndConsumer_ConsumerId(1L, 100L, 10L))
            .thenReturn(false);
        when(listingReviewRepository.save(any(ListingReview.class))).thenAnswer(invocation -> {
    ...
    private ListingReview review(Long reviewId, Order order, ConsumerProfile consumer, Listing listing) {
