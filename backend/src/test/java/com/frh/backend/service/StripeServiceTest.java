...
class StripeServiceTest {
  ...
  void createCheckoutSession_withoutKey_throwsIllegalState() {
    ...
    StripeService.StripeLineItem lineItem =
        new StripeService.StripeLineItem("Bread", 2, new BigDecimal("3.50"));
  ...
  void createCheckoutSession_success_returnsUrl() throws Exception {
    ...
    StripeService.StripeLineItem first =
        new StripeService.StripeLineItem("Bread", 2, new BigDecimal("3.50"));
    StripeService.StripeLineItem second =
        new StripeService.StripeLineItem("Soup", 1, new BigDecimal("4.20"));
