...
class SupplierOrderQueuePageControllerTest {
    ...
    void showOrderQueue_defaultStatus() throws Exception {
        ...
        Mockito.when(orderService.getOrderQueue(10L, "PENDING"))
                .thenReturn(List.of(dto));

        mockMvc.perform(get("/supplier/order-queue/{storeId}", 10L))
    ...
    void showOrderQueue_customStatus() throws Exception {
        ...
        Mockito.when(orderService.getOrderQueue(10L, "ACCEPTED"))
                .thenReturn(List.of());
    ...
    void acceptOrder_success() throws Exception {
        ...
        Mockito.when(orderService.acceptOrder(100L))
                .thenReturn(new Order());

        mockMvc.perform(post("/supplier/order-queue/{storeId}/accept", 10L)
                        .param("orderId", "100"))
    ...
    void rejectOrder_success() throws Exception {
        ...
        Mockito.when(orderService.rejectOrder(200L, "Out of stock"))
                .thenReturn(new Order());

        mockMvc.perform(post("/supplier/order-queue/{storeId}/reject", 10L)
                        .param("orderId", "200")
    ...
    void cancelOrder_success() throws Exception {
        ...
        mockMvc.perform(post("/supplier/order-queue/{storeId}/cancel", 10L)
                        .param("orderId", "300")
