...
class InteractionControllerTest {
  ...
  void recordInteraction_success() throws Exception {
    ...
    Mockito.when(interactionService.recordInteraction(Mockito.any())).thenReturn(interaction);
  ...
  void recordInteraction_failure() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.message").value("Failed to record interaction"));
  }
  ...
  void recordInteractionsBatch_success() throws Exception {
    ...
    Mockito.doNothing().when(interactionService).recordInteractionsBatch(Mockito.anyList());
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.message").value("Batch interactions recorded successfully"));
  }
  ...
  void recordInteractionsBatch_failure() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(status().isInternalServerError())
        .andExpect(jsonPath("$.success").value(false))
        .andExpect(jsonPath("$.message").value("Failed to record batch interactions"));
  }
  ...
  void healthCheck_success() throws Exception {
    ...
    mockMvc
        .perform(get("/api/interactions/health"))
        .andExpect(status().isOk())
