...
class ConsumerControllerTest {
    ...
    void getConsumerById_success() throws Exception {
        ...
        Mockito.when(consumerService.getConsumerById(1L))
                .thenReturn(Optional.of(consumer));

        mockMvc.perform(get("/api/consumer/{consumerId}", 1L))
    ...
    void getConsumerById_notFound() throws Exception {
        ...
        Mockito.when(consumerService.getConsumerById(99L))
                .thenReturn(Optional.empty());

        mockMvc.perform(get("/api/consumer/{consumerId}", 99L))
    ...
    void getConsumerByEmail_success() throws Exception {
        ...
        mockMvc.perform(get("/api/consumer/by-email")
    ...
    void getConsumerByEmail_notFound() throws Exception {
        ...
        mockMvc.perform(get("/api/consumer/by-email")
                ...
                .andExpect(jsonPath("$.error")
                        .value("Consumer not found with email: missing@test.com"));
    }
}
