...
class SupplierInventoryControllerTest {
  ...
  void getStock_success() throws Exception {
    ...
    mockMvc
        .perform(get("/api/supplier/inventory/{listingId}", 1L))
  ...
  void getStock_success_withListingId() throws Exception {
    ...
    Mockito.when(inventoryService.getInventory(42L)).thenReturn(inventory);

    mockMvc
        .perform(get("/api/supplier/inventory/{listingId}", 42L))
        .andExpect(status().isOk())
  ...
  void getStock_nullInventory_returnsDefaultResponse() throws Exception {
    ...
    Mockito.when(inventoryService.getInventory(1L)).thenReturn(null);

    mockMvc.perform(get("/api/supplier/inventory/{listingId}", 1L)).andExpect(status().isOk());
  }
  ...
  void adjustInventory_success() throws Exception {
    ...
    Mockito.when(inventoryService.adjustInventory(1L, 5)).thenReturn(updated);

    mockMvc
        .perform(
            put("/api/supplier/inventory/{listingId}/adjust", 1L)
  ...
  void adjustInventory_negativeStock_error() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.error").value("Cannot adjust below zero"));
  }
  ...
  void getStock_notFound() throws Exception {
    ...
    mockMvc
        .perform(get("/api/supplier/inventory/{listingId}", 99L))
  ...
  void adjustInventory_zeroDelta() throws Exception {
    ...
    Mockito.when(inventoryService.adjustInventory(1L, 0)).thenReturn(updated);
  ...
  void adjustInventory_largeDelta() throws Exception {
    ...
    Mockito.when(inventoryService.adjustInventory(1L, 1000)).thenReturn(updated);
  ...
  void adjustInventory_toZero() throws Exception {
    ...
    Mockito.when(inventoryService.adjustInventory(1L, -10)).thenReturn(updated);
  ...
  void adjustInventory_multipleAdjustments() throws Exception {
    ...
    Mockito.when(inventoryService.adjustInventory(1L, 5)).thenReturn(inventory1);
    Mockito.when(inventoryService.adjustInventory(1L, -3)).thenReturn(inventory2);
  ...
  void getStock_differentListings() throws Exception {
    ...
    Mockito.when(inventoryService.getInventory(1L)).thenReturn(inventory1);
    Mockito.when(inventoryService.getInventory(2L)).thenReturn(inventory2);
    ...
    mockMvc
        .perform(get("/api/supplier/inventory/{listingId}", 2L))
        .andExpect(status().isOk())
