...
class RecommendationControllerTest {
    ...
    void getHomepageRecommendations_success() throws Exception {
        ...
        Mockito.when(recommendationService.recommendStoresForHomepage(
                Mockito.eq(1L),
                Mockito.eq(5),
                Mockito.any(),
                Mockito.any()))
    ...
    void searchWithRecommendations_success() throws Exception {
        ...
        Mockito.when(recommendationService.searchWithRecommendations(
                Mockito.eq(1L),
                Mockito.eq("bread"),
                Mockito.eq(10),
                Mockito.any(),
        ...
        mockMvc.perform(get("/api/recommendations/search")
                ...
                .andExpect(jsonPath("$.message")
                        .value("Search recommendations retrieved successfully"));
    }
    ...
    void searchWithRecommendations_failure() throws Exception {
        ...
        mockMvc.perform(get("/api/recommendations/search")
                ...
                .andExpect(jsonPath("$.success").value(false))
                .andExpect(jsonPath("$.message")
                        .value("Failed to retrieve search recommendations"));
    }
